...
//	}
    ...
    private static void loadMap(RegionData regionData) {
        try {
            ...
            if (file1 == null) {
                file1 = getBuffer(new File(Server.getDataDirectory() + "/mapdata/maps/" + regionData.getObjects() + ".gz"));
            } else {
                customMapFiles++;
            }
            if (file2 == null) {
                file2 = getBuffer(new File(Server.getDataDirectory() + "/mapdata/maps/" + regionData.getLandscape() + ".gz"));
            } else {
                customMapFiles++;
            }
